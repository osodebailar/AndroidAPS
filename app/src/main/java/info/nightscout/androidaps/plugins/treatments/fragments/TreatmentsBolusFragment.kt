...
class TreatmentsBolusFragment : DaggerFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.swipeRefreshBolus.setColorSchemeResources(R.color.orange, R.color.green, R.color.blue)
        binding.swipeRefreshBolus.setProgressBackgroundColorSchemeColor(resourceHelper.gc(R.color.swipe_background))
        ...
        if (nsUploadOnly) {
            binding.swipeRefreshBolus.isEnabled = false
        } else {
            binding.swipeRefreshBolus.setOnRefreshListener {
                mRunnable = Runnable {
                    ...
                    binding.swipeRefreshBolus.isRefreshing = false
                }
